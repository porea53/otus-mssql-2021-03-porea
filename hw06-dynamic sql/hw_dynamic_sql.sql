...
select @custList = STRING_AGG(CAST(QUOTENAME(C.CustomerName) AS NVARCHAR(MAX)),',') WITHIN GROUP (ORDER BY CustomerName ASC)
from Sales.Customers AS C;

SET @command = 'SELECT FORMAT(PVT.InvoiceMonth, ''dd.MM.yyyy'') AS InvoiceMonth,';
SET @command = @command + @custList;
